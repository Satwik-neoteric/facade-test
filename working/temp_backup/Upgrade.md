Convert the app into a .net asp core 8 or 9 application. Use the existing static we content which works well, However covert the app.py to asp c# as a labelling page.
...
Guidelines: 
- Decide whether to use ASP 8 or 9. 9 is newer and has more features, however there may be less examples for you to use.
...
MVC with jQuery and JavaScript frameworks
